public class Duranto extends Train{
    private String meal;

    public Duranto( int trainNumber,String sourceStation,String sourcePlatform,String destinationStation,String destinationPlatform,String classType,String quota,int departTime,int arrivalTime,double amount,String meal) {
    ...
    public String toString() {
        return "--------------------------------------------------------------------------------------------------------------------\n"
                + "Train Name: Duranto \tTrain Number: " + getTrainNumber() + "\nSource Station: " + getSourceStation()
